...
# curl -s -L "https://raw.githubusercontent.com/bigbinary/QuizIt/master/.scripts/sync_with_QuizIt.sh" | bash
...
raw_base_url="https://raw.githubusercontent.com/bigbinary/QuizIt/main"
declare -a configs=(
  ".eslintrc.js"
  ".eslintignore"
